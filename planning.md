...
Assess whether the text reads as human or AI generated based on the overall semantic, structural, and stylistic patterns.
...
Measures statistical properties of the writing - which includes sentence length variable, typo-token ratio (vocabulary diversity), punctuation density, or average sentence complexity.

**What does the output look like**

* Between `0.00 - 1.00`

**How will the scores be combined**
...
* The `text_id`
* The raw text
* The system's attribution result
* The individual confidence scores produced by the LLM-based classification (Groq) and Stylometric Heuristics
* The combined confidence score
* The transparency label
* The creator's requested classification
